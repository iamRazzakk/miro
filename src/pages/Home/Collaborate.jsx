        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                <div className="p-10">
                    ...
                    <p className="text-[#050038] text-base">Our free plan gives you unlimited team members, 3 boards, and 300+ expert-made templates. Signing up with your work email lets you bring in your team faster. See our <span className="text-[#4262FF]">pricing plans</span> for more features.</p>
                </div>
                <div className="p-10">
                    <h1 className="text-xl font-bold mb-4 text-[#050038]">Easy integrations</h1>
                    <p className="text-[#050038] text-base">
                        Miro has 100+ powerful integrations with tools you already use like G Suite, Slack, and Jira, so your workflow is seamless. View the full list in our. for more features. <span className="text-[#4262FF]">Marketplace</span></p>
                </div>
                <div className="p-10">
