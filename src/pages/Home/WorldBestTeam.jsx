...
const WorldBestTeam = () => {
    return (
        <div className="px-4 lg:px-6">
            <h1 className='text-3xl font-bold mb-2 lg:mb-4 text-center'>Loved by the world's best teams</h1>
            <div className="flex justify-center">
                <button className="mt-8 px-10 py-4 border border-blue-500 rounded-full">See all customer stories →</button>
            </div>
            <div className="grid lg:mt-20 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* First one */}
                <div className="lg:h-[460px] p-10">
                    <h1 className='text-3xl font-bold text-[#050038]'>VMWare</h1>
                    <p className="mt-4 text-base lg:mt-10">
                    ...
                    <div className="flex gap-4 items-center lg:mt-4 mt-3">
                ...
                <div className="lg:h-[460px] p-10">
                    ...
                    <p className="mt-4 lg:mt-10 text-base">
