...
const WorkTogether = () => {
    ...
    return (
        <div className="md:flex gap-4   md:mt-32">
            <div className="md:flex-1  md:py-36 py-8 md:px-8  ">
                <h1 className=" text-[#050038] text-5xl font-bold">Work together, <br /> wherever you work</h1>
                <p className="text-[#050038] mt-2 md:mt-4">In the office, remote, or a mix of the two, with Miro, your team can connect, collaborate, and co-create in one space no matter where you are.</p>
