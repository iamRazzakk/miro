...
import HeaderImage from '../../assets/image3.png';
const Header = () => {

    return (
        <div className="flex">
            <div className="flex-1">
                <h1 className="text-3xl font-bold text-[#050038]">Take ideas from better to best</h1>
                <p>Miro is your team is visual platform to connect, collaborate, and create — together.</p>
                <input className="px-10 py-2 border border-gray-400 rounded-3xl" type="email" placeholder="Enter your Email" name="" id="" /> <br />
                <button className="mt-4 md:mt-6 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium transition duration-300 ease-out border-2 bg-[#4262FF] text-white rounded-full shadow-md group">
